...
exit_tech = 0
dialoge = 1
orange_image = pyglet.image.load('../imgs/cursor_orange.png')
orange = pyglet.sprite.Sprite(orange_image,
                              x = -100,
                              y = - 100,
                              batch = batch,
                              group = foreground)
background_image = pyglet.image.load('../imgs/background.png')
...
screen_image = pyglet.image.load('../imgs/Letschat_screen.png')
screen = pyglet.sprite.Sprite(screen_image,
                              x = window.width // 4,
                              y = window.height //10,
                              batch = batch,
                              group = background)
green_image = pyglet.image.load('../imgs/Green_Button.png')
green = pyglet.sprite.Sprite(green_image,
                              x = -100,
                              y = -100,
                              batch = batch,
                              group = foreforeground)
dialog_image = pyglet.image.load('../imgs/dialog.png')
dialog1_image = pyglet.image.load('../imgs/dialog1.png')
dialog2_image = pyglet.image.load('../imgs/dialog2.png')
...
dialog2 = pyglet.sprite.Sprite(dialog2_image,
                              ...
                              batch = batch,
                              group = background)
eXit_image = pyglet.image.load('../imgs/cursor_exit_tech.png')
eXit = pyglet.sprite.Sprite(eXit_image,
                            x = -200,
                            y=-200,
                            batch = batch,
                            group = foreforeground)
tech_image = pyglet.image.load('../imgs/Technical_works.png')
